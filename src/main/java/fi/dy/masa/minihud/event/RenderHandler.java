...
public class RenderHandler implements IRenderer
{
    ...
    private void addLine(InfoToggle type)
    {
        ...
        else if (type == InfoToggle.TIME_HOURS) {
            long total = world.getTime();
            double hours = total / 72000.0;  // Use double for more precision
            this.addLine(String.format("Hours: %.3f", hours));  // %.2f specifies two decimal places
        }
